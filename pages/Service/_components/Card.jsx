      ...
      <div class="card-section">
        ...
        <div class="flipping-cards">
          <div class="profile-card first-profile-card">
            ...
            <div className="profile-card-back profile-card-face rounded-lg border shadow-lg ">
              <div className="about-section ">
                ...
                <p className="flex gap-4 justify-center">
                  <Link href="">
                    <svg
                      ...
                      height="25"
                      fill="red"
                      className="bi bi-instagram hover:opacity-40  "
                      viewBox="0 0 16 16"
                    >
                ...
                <p className="flex justify-center  ">
                  <Button className="text-white bg-green-400  hover:bg-green-400 focus:ring-4 w-60 focus:ring-green-300 font-medium rounded-lg text-sm  mt-10 mb-2 dark:bg-green-400 dark:hover:bg-green-700 focus:outline-none dark:focus:ring-green-800">
                    Profile
                  </Button>
                </p>
              </div>

              <div className="interests-section"></div>
            </div>
          </div>
        </div>
      </div>
